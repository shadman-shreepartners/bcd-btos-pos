...
import { Briefcase, FileChartColumnIncreasing, Globe, History, Home, List, Map, Newspaper } from "lucide-react";
...
export const sidebarNavSections: SidebarNavSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { to: "/international-travel", labelKey: "International Travel", icon: Globe },
    ...
    },
    {
        ...
        items: [{ to: "/reservations", labelKey: "Reservation List", icon: List },
